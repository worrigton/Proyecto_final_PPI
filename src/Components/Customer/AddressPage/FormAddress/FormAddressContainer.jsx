...
const FormAddressContainer = ({ alertActions, customerId }) => {
...
FormAddressContainer.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(FormAddressContainer);
