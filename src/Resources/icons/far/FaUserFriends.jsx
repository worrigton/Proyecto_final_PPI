...
const FaUserFriends = ({ className, ...rest }) => (
	<svg
		style={{
			height : "1rem",
			width  : "1.5rem",
		}}
		className={`svg-inline--fa fa-user-friends fa-w-20 ${className}`}
		aria-hidden="true"
		focusable="false"
		data-prefix="far"
...
FaUserFriends.propTypes = {
	className : PropTypes.string,
};

FaUserFriends.defaultProps = {
	className : "",
};

export default FaUserFriends;
