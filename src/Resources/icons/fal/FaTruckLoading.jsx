...
const FaTruckLoading = ({ className, ...rest }) => (
	<svg
		style={{
			height : "1rem",
			width  : "1.5rem",
		}}
		className={`svg-inline--fa fa-truck-loading fa-w-20 ${className}`}
		aria-hidden="true"
		focusable="false"
		data-prefix="fal"
...
FaTruckLoading.propTypes = {
	className : PropTypes.string,
};

FaTruckLoading.defaultProps = {
	className : "",
};

export default FaTruckLoading;
