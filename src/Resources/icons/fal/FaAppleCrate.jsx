...
const FaAppleCrate = ({ className, ...rest }) => (
	<svg
		style={{
			height : "1rem",
			width  : "1.5rem",
		}}
		className={`svg-inline--fa fa-apple-crate fa-w-20 ${className}`}
		aria-hidden="true"
		focusable="false"
		data-prefix="fal"
...
FaAppleCrate.propTypes = {
	className : PropTypes.string,
};

FaAppleCrate.defaultProps = {
	className : "",
};

export default FaAppleCrate;
