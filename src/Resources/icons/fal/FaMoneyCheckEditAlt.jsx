...
const FaMoneyCheckEditAlt = ({ className, ...rest }) => (
	<svg
		style={{
			height : "1rem",
			width  : "1.5rem",
		}}
		className={`svg-inline--fa fa-money-check-edit-alt fa-w-20 ${className}`}
		aria-hidden="true"
		focusable="false"
		data-prefix="fal"
		data-icon="money-check-edit-alt"
		role="img"
...
FaMoneyCheckEditAlt.propTypes = {
	className : PropTypes.string,
};

FaMoneyCheckEditAlt.defaultProps = {
	className : "",
};

export default FaMoneyCheckEditAlt;
